...
map("n", "<Tab>2", ":lua require('harpoon.ui').nav_file(2)<CR>", default_options)
map("n", "<Tab>3", ":lua require('harpoon.ui').nav_file(3)<CR>", default_options)
map("n", "<Tab>4", ":lua require('harpoon.ui').nav_file(4)<CR>", default_options)
